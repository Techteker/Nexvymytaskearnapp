...
export const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-2 pb-6 bg-gradient-to-t from-gaming-blue-900 to-transparent pointer-events-none">
      <nav className="max-w-md mx-auto bg-white border-t border-slate-200 pointer-events-auto flex items-end justify-between px-2 py-2 relative rounded-t-3xl shadow-[0_-10px_30px_rgba(124,58,237,0.1)]">
        {navItems.map((item) => {
