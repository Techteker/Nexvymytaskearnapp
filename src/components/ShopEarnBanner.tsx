    ...
    >
      <div className="relative z-10 flex items-center justify-between">
        ...
        <div className="relative">
          <div className="w-16 h-16 bg-emerald-500/30 rounded-2xl flex items-center justify-center border border-emerald-400/20 rotate-12 group-hover:rotate-0 transition-transform duration-500">
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-emerald-400/5 rounded-full -ml-12 -mb-12"></div>
    </motion.div>
  );
};
