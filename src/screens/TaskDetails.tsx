...
import { ArrowLeft, Clock, Shield, Upload, CheckCircle2, AlertCircle, User, Mail, Smartphone, ExternalLink } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-black uppercase text-slate-400 ml-2">Task Verification Details</label>
              <div className="flex flex-col gap-3">
                <div className="relative">
                  ...
                  <input 
                    type="text" 
                    value={task?.title || ''} 
                    className="w-full bg-white border border-slate-100 rounded-2xl py-4 pl-12 pr-4 text-xs font-black text-slate-400 focus:outline-none"
                    readOnly
                  />
                </div>
                <div className="relative">
            ...
            {task.requirements?.requireTextProof && (
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-white border border-slate-200 rounded-2xl py-4 px-5 text-sm font-bold text-slate-900 focus:outline-none focus:border-brand-purple min-h-[100px] shadow-sm"
                  required
                />
              </div>
            )}

            {task.requirements?.requireScreenshot && (
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black uppercase text-slate-400 ml-2">Upload Screenshot</label>
                <input 
                  type="file" 
                  id="proof-upload" 
                  className="hidden" 
