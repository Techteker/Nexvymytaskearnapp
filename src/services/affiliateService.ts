...
export const affiliateService = {
  async getPartners() {
    try {
      ...
      return res.documents as unknown as AffiliatePartner[];
    } catch (e) {
      return [];
    }
  },
  ...
  async getOffers(filters: { category?: string; trending?: boolean; featured?: boolean } = {}) {
    try {
      ...
      return res.documents as unknown as AffiliateOffer[];
    } catch (e) {
      return [];
    }
  },
  ...
  async getOfferById(id: string) {
    try {
      ...
      return res as unknown as AffiliateOffer;
    } catch (e) {
      return null;
    }
  },
  ...
  async getCategories() {
    try {
      ...
      return res.documents as unknown as AffiliateCategory[];
    } catch (e) {
      return [];
    }
  },
  ...
  async getUserClaims() {
    try {
      ...
      return res.documents as unknown as AffiliateClaim[];
    } catch (e) {
      return [];
    }
  }
